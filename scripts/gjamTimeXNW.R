...
# save output
save(modDAtimeXNW, file = "outputs/modDAtime_XNWoutput.RData")
...
pdf(file="plots/modDAtime_XNWplots/alpha_plot.pdf")
...
pdf(file="plots/modDAtime_XNWplots/corr_plot.pdf")
...
wstarXNW <- .wrapperEquilAbund(output =   modDAtimeXNW, covars = c('depthcm', 'avgT', 'Ndep'), BYGROUP = T,
                               nsim = 10, ngrid=10, 
                               verbose = T)
save(wstarXNW, file = "outputs/wstar_XNWoutput.RData")
