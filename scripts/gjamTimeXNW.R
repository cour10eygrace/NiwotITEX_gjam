...
# save output
save(modDAtimeXNW, file = "C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_XNWoutput.RData")
...
plotPars <- list(specColor=specColor, PLOTALLY=T, GRIDPLOTS=T, CLUSTERPLOTS=T, SAVEPLOTS = T, 
                 outFolder = 'C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_XNWplots')
...
pdf(file="C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_XNWplots/alpha_plot.pdf")
...
pdf(file="C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_XNWplots/corr_plot.pdf")
...
wstarXNW <- .wrapperEquilAbund(output =   modDAtimeXNW, covars = c('depthcm', 'avgT', 'Ndep'), BYGROUP = T,
                               nsim = 10, ngrid=10, 
                               verbose = T)
save(wstarXNW, file = "C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/wstar_XNWoutput.RData")
#load(file = "C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/wstar_XNWoutput.RData")
