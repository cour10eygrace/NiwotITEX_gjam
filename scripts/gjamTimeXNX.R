...
# save output
save(modDAtimeXNX, file = "outputs/modDAtime_XNXoutput.RData")
...
pdf(file="plots/modDAtime_XNXplots/alpha_plot.pdf")
...
pdf(file="plots/modDAtime_XNXplots/corr_plot.pdf")
...
wstarXNX <- .wrapperEquilAbund(output =   modDAtimeXNX, covars = c('depthcm', 'avgT', 'Ndep'), BYGROUP = F,
                               nsim = 100, ngrid=10, 
                               verbose = T)
save(wstarXNX, file = "outputs/wstar_XNXoutput.RData")
