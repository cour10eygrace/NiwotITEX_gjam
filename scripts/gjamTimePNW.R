...
# save output
save(modDAtimePNW,file = "outputs/modDAtime_PNWoutput.RData")
...
plotPars <- list(specColor=specColor, PLOTALLY=T, GRIDPLOTS=T, CLUSTERPLOTS=T, SAVEPLOTS = T, 
                 outFolder = 'plots/modDAtime_PNWplots')
...
pdf(file="plots/modDAtime_PNWplots/alpha_plot.pdf")
...
pdf(file="plots/modDAtime_PNWplots/corr_plot.pdf")
