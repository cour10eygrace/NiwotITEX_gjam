...
# save output
save(modDAtimePNW,file = "C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_PNWoutput.RData")
...
plotPars <- list(specColor=specColor, PLOTALLY=T, GRIDPLOTS=T, CLUSTERPLOTS=T, SAVEPLOTS = T, 
                 outFolder = 'C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_PNWplots')
...
pdf(file="C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_PNWplots/alpha_plot.pdf")
...
pdf(file="C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/modDAtime_PNWplots/corr_plot.pdf")
...
wstarPNW <- .wrapperEquilAbund(output =   modDAtimePNW, covars = c('depthcm', 'avgT', 'Ndep'), BYGROUP = T,
                               nsim = 10, ngrid=10, 
                               verbose = T)
save(wstarPNX, file = "C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/wstar_PNWoutput.RData")
#load(file = "C:/Users/court/Google Drive/CU Postdoc/LTREB/gjam/wstar_PNWoutput.RData")
